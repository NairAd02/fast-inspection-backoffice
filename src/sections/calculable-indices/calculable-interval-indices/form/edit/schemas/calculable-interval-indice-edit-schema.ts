...
import { z } from "zod";
import {
  IndicatorIntervalEdit,
  indicatorIntervalEditSchema,
} from "./indicator-interval-edit-schema";

export interface CalculableIntervalIndiceEdit {
  nombre: string;
  calculo: Calculos;
  indicadoresIntervalos: IndicatorIntervalEdit[];
}

export const calculableIntervalIndiceEditSchema = z
  .object({
    nombre: z
      .string()
